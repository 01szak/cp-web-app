          ...
          <div class="collage-item" (click)="onPhotoClick()">
            <div class="collage-item__content">
              ...
              <div class="collage-item__overlay">
                <span class="collage-item__zoom-icon">
                  {{ transService.t.about.photoGallery.see }}</span
                >
              </div>
            </div>
          </div>
      ...
      @if (showButton) {
        <div class="collage-actions">
          <button class="btn-gallery" (click)="onPhotoClick()">
            {{ transService.t.about.photoGallery.seeFullGallery }}
          </button>
        </div>
      }
    </div>
...
export class PhotoCollageComponent {
  ...
  protected readonly transService = inject(TranslationService);
